...
type MaterialHeaderProps = Pick<SectionRendererProps<MaterialItem>, 'item' | 'userLocalStore' | 'onUpdateItem' | 'onDelete'>;

export function MaterialSectionHeader({ item, userLocalStore, onUpdateItem, onDelete }: MaterialHeaderProps) {
