...
type SubmissionItem = Extract<import('@/types/course-content').CourseContent, { type: 'submission' }>;
type SubmissionHeaderProps = Pick<SectionRendererProps<SubmissionItem>, 'item' | 'userLocalStore' | 'onUpdateItem' | 'onDelete'>;

export function SubmissionHeader({ item, userLocalStore, onUpdateItem, onDelete }: SubmissionHeaderProps) {
